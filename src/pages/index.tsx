    ...
    <div className="p-0">
      ...
      <main className="mt-24 max-w-3xl mx-auto">
        <div className="flex flex-col w-full">
          <div className="font-extrabold text-3xl my-8">My Boards</div>
            ...
            <table className="w-full table-auto text-left border-separate border-spacing-0">
              ...
              <tbody>
                {data?.map((board) => (
                  ...
                  >
                    <td className="font-medium p-3">{board.name}</td>
          ...
          <div className="my-2 py-2">
            <div className="flex flex-col space-y-2">
              <div className="flex">
                ...
                <div className="text-gray-500">{selected?.name}</div>
              </div>
              <div className="flex">
                <div className="mr-4 font-medium">ID:</div>
                <div className="text-gray-500">{selected?.id}</div>
              </div>
              <div className="flex">
              ...
              <CustPopover>
                <div className="overflow-hidden rounded-lg shadow-lg ring-1 ring-black ring-opacity-5">
                  <div className="relative divide-y divide-gray-200 flex flex-col  bg-white p-3 ">
                    <div className="pb-2">
                      <Link href={`/${selected?.id}?size=fullscreen`}>
                        <a
                        ...
                        >
                          ...
                          <div className="ml-4">
                            ...
                            <p className="text-sm text-gray-500 group-hover:text-violet-500">
                              Open in fullscreen mode with no menu
                            </p>
                          </div>
                        </a>
                      </Link>
                    ...
                    <div className="pt-2">
                      <Link href={`/${selected?.id}?size=windowed`}>
                        <a
                          className="flex items-center rounded-lg p-2 transition duration-150 ease-in-out hover:bg-violet-100 
