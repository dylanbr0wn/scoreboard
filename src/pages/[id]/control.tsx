        ...
        <div className="max-w-3xl mt-24 mx-auto">
          ...
          <div className="flex mt-8 pt-2 border-t border-gray-200 w-full">
            <div className="flex flex-col space-y-2 w-full">
              <div className="text-sm text-gray-600 font-light ">Board</div>
              ...
              <div className="flex pt-4 justify-between w-full">
                <div className="flex flex-col">
                  ...
                  <div className="flex space-x-2">
                    <button
                      onClick={() => {
                        if (data?.board?.initialTimeStateChange === null) {
                          mutation.mutate({
                            id,
                            data: {
                              isRunning: true,
                              initialTimeStateChange: new Date(),
                              lastTimeStateChange: new Date(),
                            },
                          });
                        } else {
                          mutation.mutate({
                ...
                <div className="flex flex-col space-y-2 ">
                  ...
                  <div className="text-xl my-auto">
                    {data?.board?.initialTimeStateChange
                      ? dayjs(data?.board?.initialTimeStateChange).format(
                          "DD/MM/YYYY HH:mm:ss"
                        )
                      : "Not yet started"}
                  </div>
                ...
                <div className="flex flex-col space-y-2 ">
                  ...
                  <div className="text-xl my-auto">
                    {data?.board?.lastTimeStateChange
                      ? dayjs(data?.board?.lastTimeStateChange).format(
                          "DD/MM/YYYY HH:mm:ss"
                        )
                      : "Not yet started"}
                  </div>
