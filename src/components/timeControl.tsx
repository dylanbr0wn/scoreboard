      ...
      {Number(board?.goalTime) !== NaN && (
        <div className="flex flex-col">
          <form className="flex space-x-3" onSubmit={handleSubmit(onSubmit)}>
            <div className="flex flex-col">
              <div className="font-thin text-sm text-gray-500">Hrs</div>
              <input
                type="number"
                {...register("hours", {
                  valueAsNumber: true,
            ...
            <div className="flex flex-col">
              <div className="font-thin text-sm text-gray-500">Min</div>
              <input
                type="number"
                {...register("minutes", {
                  valueAsNumber: true,
            ...
            <div className="flex flex-col">
              <div className="font-thin text-sm text-gray-500">Sec</div>
              <input
                type="text"
                {...register("seconds", {
                  valueAsNumber: true,
            ...
            <div className="flex flex-col">
              <div className="font-thin text-sm text-gray-500">MSec</div>
              <input
                type="number"
                {...register("millis", {
                  valueAsNumber: true,
            ...
            <div className="mt-auto pl-8">
              <button
                disabled={board?.isRunning || !isDirty || !isValid}
